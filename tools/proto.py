...
trackdata = [
    ...
    'cyintro',
    0xf0, 'lo_cybass1', 'hi_cybass1', 0x04, 0xf0, 'lo_cybd2', 'hi_cybd2', 0x01, 0xf0, 'lo_cyclap', 'hi_cyclap', 0x08, 0xf0, 'lo_cylead1', 'hi_cylead1', 0x02, 0xfe, 0xff,
    'track',
...
def advance():
    ...
    while True:
        ...
        if byte == REF_COMMAND:
            ...
            print(f'{a:02x}', offset, 'NOTE', byte)
            # Read note
            if byte == 0:
                # Rest
    ...
    while True:
        ...
        for i in range(4):
            ...
            if resetFlag:
                ...
                a = clipstart
                advance()
                print('advanced clip because of resetFlag', i)
                print_mem()

        print('after subclips')
        print_mem()
